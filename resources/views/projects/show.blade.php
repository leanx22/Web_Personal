...
<div class="px-4 max-h-full"> 
    ...
    <div class="mt-12 mx-auto bg-white dark:bg-gray-800 w-full max-w-[1450px] min-h-2 shadow-lg rounded-md grid grid-cols-12 md:py-8">
        ...
        <div class="col-span-12 md:col-span-6 p-2 flex flex-col items-center min-w-[290px]">
            ...
            <div class="p-1">
                <small class="text-gray-500 dark:text-gray-300 ms-4">Veces visto: 0</small>
                <small class="text-gray-500 dark:text-gray-300 ms-8">Interacciones totales: 0</small>
            </div>
            <div class="flex flex-col items-center lg:w-full lg:px-4">
                ...
                hover:bg-indigo-400 auto_fade">GitHub</button>
                <button class="p-2 rounded-md bg-lime-600 text-white font-bold min-w-[250px] min-h-[64px] lg:w-full lg:max-w-[375px] my-1 shadow-md
                hover:bg-lime-500 auto_fade">Ver en web</button>
            </div>
        </div>
        <!--Desc&links-->
